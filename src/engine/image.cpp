...
void engine::drawRect(renderer::Device &device, Effect *fx, float x, float y, float w, float h)
{
	x -= 0.5f;
	y -= 0.5f;
	...
	const float verts[] = {
		...
		x + w, y,     0.5f, 1.0f, 1.0f, 0.0f,
		x + w, y + h, 0.5f, 1.0f, 1.0f, 1.0f,
		x,     y + h, 0.5f, 1.0f, 0.0f, 1.0f,
	};
